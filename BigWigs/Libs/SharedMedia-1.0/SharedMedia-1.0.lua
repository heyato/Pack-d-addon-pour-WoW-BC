...
local vmajor, vminor = "SharedMedia-1.0", "$Revision: 45059 $"
...
local function activate(self, oldLib, oldDeactivate)
	...
	elseif locale == "zhCN" then
		mediaTable["font"]["任务"] = "Fonts\\FZBWJW.TTF"
		mediaTable["font"]["伤害数字"] = "Fonts\\FZJZJW.TTF"
		mediaTable["font"]["默认"] = "Fonts\\FZLBJW.TTF"
		mediaTable["font"]["提示信息"] = "Fonts\\FZXHJW.TTF"
		mediaTable["font"]["聊天"] = "Fonts\\FZXHLJW.TTF"
	end
