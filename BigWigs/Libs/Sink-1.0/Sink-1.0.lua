...
local SINK10_MINOR = string.match("$Revision: 46784 $", "[0-9]+")
...
if l == "koKR" then
	...
	L_PARROT = "Parrot"
	L_OUTPUT = "출력"
	L_OUTPUT_DESC = "이 애드온의 출력 메시지를 변경합니다."
	L_SCROLL = "스크롤 영역"
...
elseif l == "zhTW" then
	...
	L_PARROT = "Parrot"
	L_OUTPUT = "顯示模式"
	L_OUTPUT_DESC = "設定顯示模式"
	L_SCROLL = "滾動區域"
	L_SCROLL_DESC = "設置滾動訊息出現位置"
	L_NONE = "隱藏"
	L_NONE_DESC = "隱藏所有信息"
end
...
local function sct(addon, text, r, g, b, font, size, outline, sticky)
	...
	local location = (loc == "Incoming" and SCT.FRAME1) or (location == "Outgoing" and SCT.FRAME2) or SCT.MSG
	local s = getSticky(addon) or sticky
...
local function rw(addon, text, r, g, b)
