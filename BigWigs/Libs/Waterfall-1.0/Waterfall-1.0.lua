...
local MINOR_VERSION = "$Revision: 46433 $"
...
function Waterfall:AddControl(...)
	...
	if currentframe.controlcount > 250 then
		if currentframe.controlcount == 251 then
			control = getObj(WaterfallLabel)
			control.r = 1
			control.g = 0
			control.b = 0
			control:SetText("More than 200 Controls in current pane.....")
			control:Refresh()
	...
	if func then
		if confirm then
			if type(confirm) == "string" then
				...
				confirmPopup(("Are you sure you want to %s"):format(this.obj.text:GetText()),linkConfirmFunc,
	...
	if func then
		if confirm then
			if type(confirm) == "string" then
				...
				confirmPopup(("Are you sure you want to %s"):format(this.obj.frame:GetText()),buttonConfirmFunc,
