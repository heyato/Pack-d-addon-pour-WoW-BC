...
local VERSION = tonumber(("$Revision: 65379 $"):match("%d+"))
...
if CowTip.revision < VERSION then
	...
	CowTip.date = ("$Date: 2008-03-22 17:13:27 -0400 (Sat, 22 Mar 2008) $"):match("%d%d%d%d%-%d%d%-%d%d")
end
...
local localization = (GetLocale() == "koKR") and {
	...
	["Unit anchor"] = "对象锚点",
	["The anchor with which unit mouseover tooltips are located."] = "设置鼠标悬停在某对象上时的提示信息框的位置。",
	["Set unit anchor offset"] = "设置对象锚点偏移位置",
	["Click this to bring up an easy-to-use offset box."] = "点击会打开一个易于使用的偏移位置对话框。",
	["Adjust"] = "调整",
	["Frame anchor"] = "框架锚点",
	["The anchor with which tooltips are located when hovering over frames."] = "设置鼠标悬停在某框架上时的提示信息框的位置。",
	["Set frame anchor offset"] = "设置框架锚点偏移位置",
	...
	["Unit anchor"] = "單位定位點",
	["The anchor with which unit mouseover tooltips are located."] = "設定單位提示訊息的定位點。",
	["Set unit anchor offset"] = "設定單位定位點位移",
	["Click this to bring up an easy-to-use offset box."] = "點擊打開易用位移輸入框。",
	["Adjust"] = "調整",
	["Frame anchor"] = "框架定位點",
	["The anchor with which tooltips are located when hovering over frames."] = "設定框架提示訊息的定位點。",
	["Set frame anchor offset"] = "設定框架定位點位移",
