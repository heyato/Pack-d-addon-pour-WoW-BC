--[[
	...
	Revision: $Id: GatherManifest.lua 653 2007-10-22 07:19:21Z root $
...
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/trunk/Gatherer/GatherManifest.lua $", "$Rev: 653 $")
